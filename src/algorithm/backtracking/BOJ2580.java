 ...
 * 3. 작업흐름
 * 
 * class algorithm.bfs.algorithm.backtracking.Point
 * 
 * 
 * static int[][] map
 * List<algorithm.bfs.algorithm.backtracking.Point> emptyCells : 0인 칸의 좌표를 채운다
 * 
 * void 백트래킹()
 ...
 * 
 * 
 * algorithm.bfs.algorithm.backtracking.Point emptyCell = emptyCells.pop()
 * 
